...
// =====================================================================
d3.csv("assets/data/viz3_chain_allocation.csv").then(raw => {
  raw.forEach(d => {
    d.tvl = +d.tvl;
...
// A) Time series (top)
d3.csv("assets/data/viz4_protocol_timeseries.csv").then(raw => {
  raw.forEach(d => {
  ...
  d3.csv("assets/data/viz4_protocol_latest.csv").then(rawLatest => {
    rawLatest.forEach(d => {
      d.tvl = +d.tvl;
...
// =====================================================================
Promise.all([
  d3.csv("assets/data/viz2_asset_type_shares.csv"),
  d3.csv("assets/data/viz5_yield_timeseries.csv")
